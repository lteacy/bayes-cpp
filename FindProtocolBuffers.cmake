...
IF (PROTOBUF_FOUND)
  ...
  FUNCTION(WRAP_PROTO VAR)
    ...
    FOREACH(FIL ${ARGN})
      ...
      SET(CURRENT_MATLAB "${PROTO_OUT_DIR}/${FIL_WE}.m")
      ...
      IF (PBMATLAB) 
        EXECUTE_PROCESS(
        	COMMAND  ${PROTOBUF_PROTOC_EXECUTABLE} --matlab_out  ${PROTO_OUT_DIR} --proto_path ${CMAKE_CURRENT_SOURCE_DIR}/proto ${ABS_FIL}
        )
      ENDIF(PBMATLAB)
